...
%
% Brief description:
%    We take a dat-file from pbrt as input. We return a scene or an optical
%    image if this is a radiance calculation:  A scene for a perspective
%    (pinhole) camera.  An oi otherwise.  If this is metadata, then the
%    ieObject is a metadata map.
%
% Inputs
