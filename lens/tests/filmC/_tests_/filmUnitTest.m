function results = filmUnitTest(mode)
% FILMUNITTEST - Run filmC tests in this _tests_ directory.
...
if exist('ieTestReport','file'), ieTestReport(results,'filmUnitTest'); end
end
...
switch mode
    ...
    case {'full','all'}
    otherwise
        error('Unknown filmUnitTest mode %s. Use ''core'' or ''full''.',mode);
end
end
