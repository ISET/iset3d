function results = paraxialUnitTest(mode)
% PARAXIALUNITTEST - Run paraxial optics tests in this _tests_ directory.
...
if exist('ieTestReport','file'), ieTestReport(results,'paraxialUnitTest'); end
end
...
switch mode
    ...
    case {'full','all'}
    otherwise
        error('Unknown paraxialUnitTest mode %s. Use ''core'' or ''full''.',mode);
end
end
