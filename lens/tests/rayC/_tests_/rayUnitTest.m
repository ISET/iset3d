function results = rayUnitTest(mode)
% RAYUNITTEST - Run rayC tests in this _tests_ directory.
...
if exist('ieTestReport','file'), ieTestReport(results,'rayUnitTest'); end
end
...
switch mode
    ...
    case {'full','all'}
    otherwise
        error('Unknown rayUnitTest mode %s. Use ''core'' or ''full''.',mode);
end
end
