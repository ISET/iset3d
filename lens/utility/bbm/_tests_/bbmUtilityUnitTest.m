function results = bbmUtilityUnitTest(mode)
% BBMUTILITYUNITTEST - Run BBM utility tests in this _tests_ directory.
...
if exist('ieTestReport','file'), ieTestReport(results,'bbmUtilityUnitTest'); end
end
...
switch mode
    ...
    case {'full','all'}
    otherwise
        error('Unknown bbmUtilityUnitTest mode %s. Use ''core'' or ''full''.',mode);
end
end
