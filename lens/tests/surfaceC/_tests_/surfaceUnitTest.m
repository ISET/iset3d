function results = surfaceUnitTest(mode)
% SURFACEUNITTEST - Run surfaceC tests in this _tests_ directory.
...
if exist('ieTestReport','file'), ieTestReport(results,'surfaceUnitTest'); end
end
...
switch mode
    ...
    case {'full','all'}
    otherwise
        error('Unknown surfaceUnitTest mode %s. Use ''core'' or ''full''.',mode);
end
end
