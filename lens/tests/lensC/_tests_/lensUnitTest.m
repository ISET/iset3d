function results = lensUnitTest(mode)
% LENSUNITTEST - Run lensC tests in this _tests_ directory.
...
if exist('ieTestReport','file'), ieTestReport(results,'lensUnitTest'); end
end
...
switch mode
    ...
    case {'full','all'}
    otherwise
        error('Unknown lensUnitTest mode %s. Use ''core'' or ''full''.',mode);
end
end
