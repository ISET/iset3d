function results = psfCameraUnitTest(mode)
% PSFCAMERAUNITTEST - Run psfCameraC tests in this _tests_ directory.
...
if exist('ieTestReport','file'), ieTestReport(results,'psfCameraUnitTest'); end
end
...
switch mode
    ...
    case {'full','all'}
    otherwise
        error('Unknown psfCameraUnitTest mode %s. Use ''core'' or ''full''.',mode);
end
end
